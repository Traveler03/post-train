...
针对这次实验，构建记录说明 v2 由老合成 PASS 池选出的 681 条和新缺口轨迹 468 条组成，再删除 92 条得到 v2.1。线上数据主要提供需求种子：先回查历史补齐 query，再构造环境、重新执行并收集 PASS。逐步字段转换和贯穿例子见[从线上日志到 SFT](data-construction.md)。
